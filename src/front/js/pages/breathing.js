				...
				<Row>
					...
					<Col sm={4}>
						<Cards
							...
							title="Dos-tips-para-respirar-correctamente"
				...
				<Row>
					<Col sm={4}>
						<Cards
							...
							title="Cinco-Puntos-clave-del-estilo-crol"
					...
					<Col sm={4}>
						<Cards
							...
							title="Técnicas-de-respiración-Estilo-Crol"
							text="En este video te mostramos una técnica de respiración en 2 etapas: rotación y vuelta a la posición de base."
						/>
					</Col>
					<Col sm={4}>
						<Cards
							video="https://www.youtube.com/embed/YuQ2FwqVS5g"
							title="Respirar-correctamente-mientras-nadas"
				...
				<Row>
					<Col sm={4}>
						<Cards
							...
							title="Cuatro-ejercicios-de-respiración-estilo-crol"
